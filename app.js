...
const NUM_STATES_IN_US = 50; //TODO: update this const if number changes

//5 + 4. Why are we storing this?
const FIVE_PLUS_FOUR = 5 + 4;
...
const FAVORITE_VEGGIES = ["Potato", "Cucumber", "Lettuce", "Carrot", "Broccoli"];
...
const HELLO_WORLD_LENGTH = getLength("Hello World");
